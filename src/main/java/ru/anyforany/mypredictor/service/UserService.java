...
import ru.anyforany.mypredictor.repository.RoleRepository;
import ru.anyforany.mypredictor.repository.UserRepository;
...
public class UserService implements UserDetailsService {
    ...
    public String getUserBalance(Long id) {
        return em.createQuery("SELECT u.balance from User u where u.id = :id").setParameter("id", id)
